    ...
    class YouTubeParser   {     
        ...
        function YouTubeParser($file){
            ...
            while($data = fread($fp, 4096)) {
                ...
                sprintf("YouTubeParser: Error <b>%s</b> at line <b>%d</b><br>",
		...
		function fixEncoding(&$input, $key, $output_encoding){
			...
			switch($encoding){
			    case 'ASCII':
				case $output_encoding: break;
				case '':$input = mb_convert_encoding($input, $output_encoding); break;
				default: $input = mb_convert_encoding($input, $output_encoding, $encoding);
			}
		}
